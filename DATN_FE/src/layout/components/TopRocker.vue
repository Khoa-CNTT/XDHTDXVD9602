            ...
            <nav class="navbar navbar-expand">
                ...
                <div class="user-box dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <a v-on:click="dangXuatAll()" class="dropdown-item" href="javascript:;"><i class="fa-solid fa-right-from-bracket"></i> <span>Đăng Xuất Tất Cả Thiết Bị</span></a>
                        </li>
                    </ul>
                </div>
            </nav>
...
export default {
    ...
    methods: {
        ...
        dangXuatAll() {
            baseRequest.get("dang-xuat-tat-ca").then((res) => {
                if (res.data.status) {
                    toaster.success("Thông báo<br>" + res.data.message);
                    this.$router.push("/login");
                } else {
