                                                ...
                                                <div class="card radius-10">
                                                    <div class="card-body">
                                                        <div class="text-center">
                                                            ...
                                                            <button v-if="v.is_mo_ban == 0" v-on:click="moBan(v, false)" class="btn btn-primary">Mở Bàn</button>
                                                            <button v-else class="btn btn-success" v-on:click="moBan(v, true)" data-bs-toggle="modal" data-bs-target="#mobanModal">Thanh Toán</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        createPrintWindow(data) {
            ...
            <div class="row">
                ...
                <div class="col text-end">
                    <img class="img-bill" src="https://img.vietqr.io/image/MB-2407202165-qr_only.jpg?amount=${this.tien_thuc_thu}&addInfo=${bill.ma_hoa_don}&accountName=TRAN_CONG_TRUC" alt="">
                </div>
            </div>
